...
export const techLogos: Record<string, { name: string; image: string }> = {
  ...
  awsCloudformation: { name: "AWS CloudFormation", image: awsLogo },
  awsCodePipeline: { name: "AWS CodePipeline", image: awsLogo },
  loki: { name: "Loki", image: simpleIcon("grafana", "F46800") },
  elasticsearch: { name: "Elasticsearch", image: simpleIcon("elasticsearch", "005571") },
  logstash: { name: "Logstash", image: simpleIcon("logstash", "005571") },
  kibana: { name: "Kibana", image: simpleIcon("kibana", "005571") },
  ansible: { name: "Ansible", image: simpleIcon("ansible", "EE0000") },
  datadog: { name: "Datadog", image: simpleIcon("datadog", "632CA6") },
  zabbix: { name: "Zabbix", image: simpleIcon("zabbix", "D40000") },
  nagios: { name: "Nagios", image: simpleIcon("nagios", "CC0000") },
  cloudwatch: { name: "CloudWatch", image: awsLogo },
  bash: { name: "Bash", image: simpleIcon("gnubash", "4EAA25") },
  newRelic: { name: "New Relic", image: simpleIcon("newrelic", "1CE783") },
  logicMonitor: { name: "LogicMonitor", image: "/tech-logos/logicmonitor.svg" },
  dynatrace: { name: "Dynatrace", image: simpleIcon("dynatrace", "1496FF") },
  glances: { name: "Glances", image: "/tech-logos/glances.svg" },
